...
typedef enum Scene { INTRO, TITLE, DONKEYSHOP ,CUTSCENE, HOWHIGH, LEVEL1, WINCUTSCENE, HOWHIGH15, LEVEL15, WINCUTSCENE15 , HOWHIGH2, LEVEL2, WINCUTSCENE2, HIGHSCORE } Scene;
