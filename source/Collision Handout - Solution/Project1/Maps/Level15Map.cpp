...
void Level15RampSetter() {
    ...
    // Nivel 3: lo que antes era nivel 2 (izq+der separadas), estiradas por los lados
    // Antes izq 4 tiles X=8, ahora 5 tiles X=0. Der antes 4 tiles X=152, ahora 5 tiles X=144
    SetFlatRamp(Ramp15_3,  5, 0,   (int)P15_Ramp3_YPos);   // mitad izquierda
    SetFlatRamp(Ramp15_4L, 5, 144, (int)P15_Ramp3_YPos);   // mitad derecha (reutilizamos Ramp15_4L para el draw)
    ...
    // Nivel 3 izq y der (las dos mitades separadas mas anchas)
